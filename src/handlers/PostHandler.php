...
class PostHandler
{
    ...
    public static function getUserFeed($idUser, $page, $loggedUserId)
    {
        ...
        $postList = Post::select()->where('id_user', $idUser)
            ->orderBy('created_at', 'desc')->page($page, $perPage)
            ->get();

        $total = Post::select()->where('id_user', $idUser)
            ->count();
    ...
    public static function getHomeFeed($idUser, $page)
    {
        ...
        $postList = Post::select()->where('id_user', 'in', $users)
            ->orderBy('created_at', 'desc')->page($page, $perPage)
            ->get();
